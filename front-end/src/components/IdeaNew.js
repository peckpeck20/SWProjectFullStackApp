      ...
      <div className="container">
        ...
        <form onSubmit={this.onSubmit}>
          ...
          <p>Ready for comment?  <span>
              <select name="readyForComments" value={this.state.newIdea.readyForComments} onChange={this.inputChanged}>
          ...
          <button type="submit" className="button button-edit button-text" style={Style.button}>
            ADD
          </button>
