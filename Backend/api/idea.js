...
router.post("/", function(req, res) {
	...
	if (req.body.title && req.body.description && req.body.budget && req.body.readyForComments && req.body.peopleNeeded && req.body.creationDate && req.body.lastModified && req.body.categoryIdea) {
